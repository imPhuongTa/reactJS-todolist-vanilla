...
function renderTodos() {
    ...
    todos.forEach((todo) => {
        ...
        deleteBtnNode.className = "btn btn-action btn-delete";
        ...
        editBtnNode.className = "btn btn-action btn-edit";
        ...
        doneBtnNode.className = "btn btn-action btn-done";
        ...
        saveBtnNode.className = "btn btn-action";
